...
create trigger trg_account_creation_requests_updated_at
...
on account_creation_requests for insert
...
on account_creation_requests for select
to authenticated
using (is_admin());

create policy account_creation_requests_update_admin
on account_creation_requests for update
to authenticated
using (is_admin())
with check (is_admin());
